                  ...
                  children: <Widget>[
                        ...
                        child: RaisedButton(
                          ...
                          onPressed: ()async{
                              if(_formKey.currentState.validate()){
                                dynamic result = await _auth.loginWithEmailAndPassword(email1, pass1);
                              ...
                              if(result ==null){
                                setState(() {
                                  ...
                                  Navigator.of(context).push(MaterialPageRoute(builder: (ctx) => StaffAC()));
                              }
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        ...
                        FlatButton(
                            onPressed: (){
                              Navigator.of(context).popAndPushNamed(StaffSignup.routeName1);
                              },
                            child: Text("SIGN UP",
                              style: TextStyle(
                                color: Colors.black,
