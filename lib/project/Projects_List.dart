...
class _ProjectsListState extends State<ProjectsList> {
  ...
  void initState() {
    ...
    ref.child("Project").once().then((DataSnapshot snap) {
      var keys = snap.value.keys;
      var data = snap.value;
      for (var key in keys) {
        User addN = new User(
          aYear: data[key]['Acadmic year'],
          name1: data[key]['Member1'],
          name2: data[key]['Member2'],
          name3: data[key]['Member3'],
          sem: data[key]['Sem'],
          pname: data[key]['projtopic'],
          year: data[key]['Year'].toString(),
        );
                ...
                children: <Widget>[
                  Container(
                    margin: EdgeInsets.fromLTRB(
                        screenWidth / 10, 15, screenWidth / 10, 0),
                    child: Text(
                      "Previous Year",
                      style: TextStyle(
